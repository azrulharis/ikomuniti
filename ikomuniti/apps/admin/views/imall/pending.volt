  		...
  		<div class="panel-body">  
		     ...
		     {% for post in posts %}
               <div class="row">
	              ...
	              <a href="{{admin_path}}imall/view/{{post.slug}}?id={{post.id}}">
				  ...
				  <div class="col-md-4 text-left" style="margin-top: 10px;">
				    <i class="glyphicon glyphicon-th-large"></i> {{post.category}}
				  </div> 
				  <div class="col-md-3 text-left" style="margin-top: 10px;">
				    <i class="fa fa-user"></i> {{post.username}}
				  </div> 
				  <div class="col-md-3 text-left" style="margin-top: 10px;">
				    {% if post.price != 0 %}<i class="fa fa-star"></i> <b>RM{{post.price}}</b>{% endif %}
				  </div> 
