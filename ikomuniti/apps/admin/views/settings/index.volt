	...
	<div class="col-lg-4"> 
		 <div class="bs-example wgreen">
          <div class="list-group">
            ...
            <a href="/ishare/isharephal/news/view/" class="list-group-item"><h4>cdddddvsdfv</h4>
			<p class="list-group-item-text">dfvgfdg fg dsfgvf sdgsf ...</p>
			</a>  
            <a href="/ishare/isharephal/news/index" class="list-group-item"> View All 
