      ...
      <div class="panel panel-primary"> 
	  	<div class="panel-body">
		    <div class="bs-example">
			  <ul class="breadcrumb" style="margin-bottom: 5px;">
			    <li><?php echo $this->tag->linkTo(array('isahabatactivations/index', 'Activate iS 1')); ?></li>
        ...
        <ul class="list-group"> 
	       ...
	       <li class="list-group-item"> 
		   	   <?php echo $this->tag->linkTo(array('activations/index?ref=' . $user->password . '&action=activate&activate=bljkX3BjVziItYbEqMZ1SOU2e8Xv6ZuRuTAztmdjVz8fOHeomyeLpuLaIZF4lHT&ntsv=' . $user->id, 'Activate As iKomuniti', 'class' => 'btn btn-success', 'onclick' => 'return confirm(\'Adakah anda pasti untuk mengaktifkan ' . $user->username . ' sebagai iKomuniti?\')')); ?>
		   &nbsp;&nbsp;&nbsp;&nbsp;
		   <?php echo $this->tag->linkTo(array('isahabatactivations/index?ref=' . $user->password . '&action=activate&activate=bljkX3BjVziItYbEqMZ1SOU2e8Xv6ZuRuTAztmdjVz8fOHeomyeLpuLaIZF4lHT&ntsv=' . $user->id, 'Activate As iSahabat', 'class' => 'btn btn-primary', 'onclick' => 'return confirm(\'Adakah anda pasti untuk mengaktifkan ' . $user->username . ' sebagai iSahabat?\')')); ?>
		   &nbsp;&nbsp;&nbsp;&nbsp;
      ...
      <div class="bs-example user-profile">
        <ul class="list-group">
	      ...
	      <li class="list-group-item"> 
		   ...
		   <?php echo $this->tag->linkTo(array('isahabatactivations/index?ref=' . $user->password . '&action=activate&activate=bljkX3BjVziItYbEqMZ1SOU2e8Xv6ZuRuTAztmdjVz8fOHeomyeLpuLaIZF4lHT&ntsv=' . $user->id, 'Activate As iSahabat', 'class' => 'btn btn-primary', 'onclick' => 'return confirm(\'Adakah anda pasti untuk mengaktifkan ' . $user->username . ' sebagai iSahabat?\')')); ?>
		   &nbsp;&nbsp;&nbsp;&nbsp;
		   <?php echo $this->tag->linkTo(array('isahabatactivations/index?ref=' . $user->password . '&action=problem&activate=bljkX3BjVziItYbEqMZ1SOU2e8Xv6ZuRuTAztmdjVz8fOHeomyeLpuLaIZF4lHT&ntsv=' . $user->id, 'Problem', 'class' => 'btn btn-danger', 'onclick' => 'return confirm(\'Adakah anda pasti untuk memindahkan ' . $user->username . ' ke bahagian Problem?\')')); ?> 
