	...
	<div class="col-lg-12">   
		...
		<div class="panel panel-primary">
		  ...
		  <ul class="breadcrumb" style="margin-bottom: 5px;">
			...
			<li><?php echo $this->tag->linkTo(array('wallets/histories', 'History')); ?></li>
		    <li><?php echo $this->tag->linkTo(array('wallets/redeem', 'Withdraw')); ?></li>
		    <li><?php echo $this->tag->linkTo(array('wallets/status', 'Withdrawal Status')); ?></li> 
			<li><?php echo $this->tag->linkTo(array('wallets/transfer', 'Transfer')); ?></li> 
		  </ul>
		</div>
			<h4>iPoint Balance <b><?php echo $wallet; ?></b></h4>
			</div>
		</div>
	</div>
		...
		<div class="panel panel-primary">
			...
			<div class="form-group" style="height: 30px;"></div>
				...
				<div class="form-group">
				  ...
				  <input type="text" name="amount" value="<?php echo $this->escaper->escapeHtml($amount); ?>" class="form-control" placeholder="1295.50" required onfocus> 
