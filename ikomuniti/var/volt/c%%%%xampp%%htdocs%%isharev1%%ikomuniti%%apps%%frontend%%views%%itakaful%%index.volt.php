    ...
    <div class="panel panel-primary">
                ...
                <div class="table-responsive">
      			<table class="table table-bordered table-hover table-striped tablesorter"> 
      			    <?php foreach ($navigations as $info) { ?>
                    <tr>
					   <td>Registration Number: </td><td><?php echo $info->reg_number; ?></td>
					 </tr>
					<?php } ?>
					<tr>
					   <td>Due Date: </td><td><?php echo $insurance->next_renewal; ?></td>
					 </tr>
                     <tr>
					   <td>Sum Insured: </td><td>RM<?php echo $insurance->cover; ?></td>
					 </tr>
                     <tr><td>Takaful Premium Amount: </td><td>RM<?php echo $insurance->insurance; ?></td></tr>
                     <tr><td>Road Tax Fee: </td><td>RM<?php echo $insurance->road_tax; ?></td></tr>
                     <tr><td>Windscreen Sum Insured: </td><td>RM<?php echo $insurance->wind_screen; ?></td></tr>
                     <tr><td>Windscreen Premium: </td><td>RM<?php echo $insurance->wind_screen * 0.15; ?></td></tr>
                     <tr><td>Free Towing Service: </td><td>RM200</td></tr></td></tr>
                     <tr><td>Car Replacement Program: </td><td><?php if ($insurance->crp == 120) { ?>
                       1 Year CRP (RM120)
                       <?php } elseif ($insurance->crp == 78) { ?>
                       Additional 9 month CRP (RM78)
                       <?php } else { ?> 
                       N/A
                       <?php } ?></td></tr>
                     <tr><td>Additional Driver Premium: </td><td>RM<?php echo $insurance->driver_total; ?></td></tr> 
                     <tr><td>Additional Driver Name: </td><td><?php echo $insurance->second_driver; ?></td></tr>
                     <tr><td>Personal Accident (PA): </td><td>
					 <?php if ($insurance->pa == 50) { ?>
					 RM50 Sum Covered RM10K per Person (Max 5 person)
					 <?php } elseif ($insurance->pa == 90) { ?>
					 RM90 Sum Covered RM20K per Person (Max 5 person)
					 <?php } elseif ($insurance->pa == 130) { ?>
					 RM130 Sum Covered RM30K per Person (Max 5 person) 
					 <?php } elseif ($insurance->pa == 170) { ?>
				     RM170 Sum Covered RM40K per Person (Max 5 person) 
				     <?php } elseif ($insurance->pa == 210) { ?>
				     RM210 Sum Covered RM50K per Person (Max 5 person)
					 <?php } else { ?>
					 N/A
					 <?php } ?> 
					 </td></tr>
                     <tr><td>Myeg Service Charge: </td><td>RM<?php echo $insurance->service_charge; ?></td></tr>
                     <tr><td>Pos Laju Tracking: </td><td><?php echo $insurance->tracking_code; ?></td></tr>
                     <tr><td>Total Amount To Pay: </td><td>RM<?php echo $insurance->total; ?></td></tr>
                     
                     <tr><td>Payment</td><td><?php echo $this->tag->linkTo(array('wallets/index?amount=' . $insurance->total, 'Pay Now', 'class' => 'btn btn-success')); ?></td></tr>
          ...
          <div class="col-lg-6">
            <div class="panel panel-primary">
                ...
                <?php echo $this->getContent(); ?>
                 <?php echo $this->tag->form(array('itakaful/index', 'method' => 'post')); ?>
                 <div class="form-group">
                   ...
                   <input type="text" name="sum" class="form-control" value="<?php echo $insurance->cover; ?>"> 
                 </div>
                 ...
                 <div class="form-group">
                   ...
                   <select name="crp" class="form-control">
                       ...
                       <?php if ($insurance->insurance >= 500) { ?>
                       <option value="78">14 Day CRP (RM78)</option>
                       <?php } elseif ($insurance->insurance < 500 && $insurance->insurance > 0) { ?>
	...
	<div class="row"> 
		<div class="col-lg-6">
	    	<div class="panel panel-primary">
		        ...
		        <div class="panel-body">
		           <h4>Pos Laju Tracking: <?php echo $insurance->tracking_code; ?></h4>
		...
		<div class="col-lg-6">
	    	<div class="panel panel-primary">
		        ...
		        <div class="panel-body">
		            <div class="result_sms" style="display:none; background-color:#FDFDFD;width:100%;height:180px;"><?php echo $this->tag->image(array('img/sms_screen.png', 'width' => 250)); ?></div>
                  <ol style="padding: 16px;">
		            ...
		            <li>Segala bukti bayaran hendaklah dikemukakan kepada pihak iShare dengan mengisi borang <?php echo $this->tag->linkTo(array('wallets/index', 'di sini', 'style' => 'color: #032EAD; font-weight: bold;')); ?>.</li>
